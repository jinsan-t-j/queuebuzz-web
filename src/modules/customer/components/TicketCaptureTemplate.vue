        ...
        >
            ...
            <div class="bg-mint px-10 py-12 text-center relative">
                ...
                <div class="flex items-center justify-center gap-2 mb-6 opacity-30">
                    <div class="h-6 w-6 rounded-lg flex items-center justify-center font-display font-black text-plum text-sm">Q</div>
                    <h3 class="font-display text-white text-sm font-bold tracking-widest uppercase">Visitor Ticket</h3>
                </div>
                
                <h1 class="font-display text-4xl font-bold leading-tight line-clamp-2">{{ queueName }}</h1>
                <p class="mt-3 font-body text-sm font-medium text-plum opacity-90 tracking-wide uppercase">Confirmed Entry</p>
            ...
            <!-- QR Code Section -->
            <div class="mx-10 mb-12 rounded-[48px] bg-sand/40 p-10 border border-plum/5 flex flex-col items-center">
                ...
                <p class="mt-8 font-body text-[10px] font-bold uppercase tracking-[0.2em] text-plum/40">Present this QR at the counter</p>
            </div>
