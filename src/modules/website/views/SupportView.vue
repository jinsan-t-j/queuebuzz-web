  ...
  <div class="support-page pb-20">
    ...
    <section class="bg-mint-light/30 px-5 pt-16 pb-16 md:px-0 md:pt-24 md:pb-24 text-center">
      <div class="mx-auto max-w-[720px]">
        <h1 class="font-display font-bold text-plum text-[36px] md:text-[56px] tracking-[-0.02em] leading-tight mb-4">
          How can we help?
        </h1>
        <p class="font-body text-plum-muted text-[16px] md:text-[18px] max-w-[540px] mx-auto">
          Have a question about QueueBuzz, need help with your account, or want to report an issue? Send us a message and we'll get back to you shortly.
        </p>
      </div>
    </section>
      ...
      <div class="bg-white rounded-2xl shadow-sm border border-plum-faint p-6 md:p-10">
        ...
        <form @submit.prevent="handleSubmit" class="flex flex-col gap-5">
          <div class="flex flex-col md:flex-row gap-5">
            ...
            <div class="flex-1 flex flex-col gap-1.5">
              <label for="email" class="font-body text-[13px] font-medium text-plum">Email Address</label>
              <input 
                id="email" 
          ...
          <div v-if="isSuccess" class="mt-4 p-4 rounded-lg bg-mint-light text-mint-dark font-body text-sm text-center border border-mint">
