...
<template>
  ...
  <div class="fixed left-[-9999px] top-[-9999px]">
    <div id="capture-host-qr" class="w-[480px] bg-sand flex flex-col items-center p-12 text-center">
      <!-- Logo / Branding -->
      <div class="mb-4">
      ...
      <!-- Main QR Frame -->
      <div
        class="p-6 bg-white rounded-[40px] shadow-[0_8px_40px_rgba(26,10,46,0.12)] border border-plum-faint mb-6"
      >
        <img v-if="qrDataUrl" :src="qrDataUrl" alt="Queue QR code" class="w-64 h-64 rounded-2xl" />
