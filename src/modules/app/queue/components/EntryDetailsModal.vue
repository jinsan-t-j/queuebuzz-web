    ...
    >
      ...
      >
        ...
        >
          <!-- Close button -->
          <button
            class="absolute right-6 top-6 flex h-10 w-10 items-center justify-center rounded-full bg-sand transition-colors hover:bg-plum/5"
            @click="emit('close')"
          >
          ...
          <div class="p-8">
            ...
            <div class="mb-8 pt-4 text-center">
              <span
                class="font-mono text-[64px] font-bold leading-none tracking-tight text-plum"
              >
            ...
            <div class="space-y-6">
              <div class="flex items-center justify-between rounded-2xl bg-sand p-4">
                <div class="flex items-center gap-3">
                  <div
                    class="flex h-10 w-10 items-center justify-center rounded-xl bg-white text-plum shadow-sm"
                  >
                    <span class="font-display text-sm font-bold">Pos</span>
                  </div>
                  <div>
                    <p
                      class="font-body text-[10px] font-bold uppercase tracking-wider text-plum/40"
                    >
                      Position
                    </p>
              ...
              <div class="space-y-4 px-2">
                <div class="flex items-center justify-between">
                  ...
                  <span class="font-body text-base font-bold text-plum">{{
                    entry.name
                  }}</span>
                </div>
                <div class="flex items-center justify-between">
                  ...
                  <span
                    class="flex items-center gap-2 font-body text-base font-bold text-plum"
                  >
