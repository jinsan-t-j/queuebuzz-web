 ...
 * @description New queue creation form. Shows a multi-section form with
 * queue name (with suggestion pills), average service time slider,
 * and optional recovery email. Displays a success modal after creation.
 *
