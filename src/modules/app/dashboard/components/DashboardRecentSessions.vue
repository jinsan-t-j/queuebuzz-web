...
<template>
  ...
  >
    <h3 class="font-body text-lg font-bold text-plum">Recent Sessions</h3>
    ...
    <div v-else class="mt-6 flex flex-col gap-4">
      ...
      >
        <div
          class="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-plum-faint/50"
        >
        ...
        <div class="flex-1 min-w-0">
          ...
          <p class="font-body text-xs text-ash">
